export const API_ENDPOINTS = {
  ...
  ACTION: {
    ...
    CREATE_ACTION_FROM_COMPANY: "/action/create_from_company/{company_id}/user/{user_id}",
  ...
  USER_DATA: {
    ...
    GET_RATING_ANALYTIC_IN_COMPANY: "/user/{user_id}/rating_analytic_in_company/{company_id}",
    GET_RATING_FOR_QUIZ: "/user/{user_id}/rating_for_quiz/{quiz_id}",
    GET_RATING_ANALYTIC_FOR_QUIZ: "/user/{user_id}/rating_analytic_for_quiz/{quiz_id}",
    ...
    MARK_NOTIFICATION_AS_READ: "/user/{user_id}/mark_notification_as_read/{notification_id}",
  },
  COMPANY_DATA: {
    ...
    GET_LAST_ANSWERS_LIST_FOR_USER: "/company/{company_id}/last_answers_list_for_user/{user_id}",
    GET_LAST_ANSWERS_CSV_FOR_USER: "/company/{company_id}/last_answers_csv_for_user/{user_id}",
    GET_LAST_ANSWERS_LIST_FOR_QUIZ: "/company/{company_id}/last_answers_list_for_quiz/{quiz_id}",
    GET_LAST_ANSWERS_CSV_FOR_QUIZ: "/company/{company_id}/last_answers_csv_for_quiz/{quiz_id}",
    GET_SUMMARY_RATING_FOR_USERS: "/company/{company_id}/summary_rating_for_users",
    GET_SUMMARY_RATING_ANALYTIC_FOR_USERS:
      "/company/{company_id}/summary_rating_analytic_for_users",
    GET_SUMMARY_RATING_FOR_USER: "/company/{company_id}/summary_rating_for_user/{user_id}",
    GET_SUMMARY_RATING_ANALYTIC_FOR_USER:
      "/company/{company_id}/summary_rating_analytic_for_user/{user_id}",
    GET_SUMMARY_RATING_FOR_QUIZ: "/company/{company_id}/summary_rating_for_quiz/{quiz_id}",
